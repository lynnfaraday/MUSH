...
This README file describes how to configure the code.  
Consult the Player's and Storyteller's guides for full details on the mechanics behind all 
of these numbers.
...
You can also set the default ruling attribute for background and language skills. 
Right now they both use the same ruling ruling attribute.  
...
* The number of points you can spend on action skills and attributes.
  ...
  &MAX_POINTS_ATTRIBUTES Skill Data=32
...
Bear in mind that the system will automatically give them the average rating (5) in every attribute 
and the default language at veteran (7), but this counts towards their overall point total!   
So make sure they have enough points to include sensible attribute and language ratings.
...
You can use underscores for weapon names, like MACHINE_GUN.
  ...
  &WEAPON_PISTOL FS3Combat Equipment Stats=Pistol|Firearms|5|0|3|Ranged|Personal|0|10|0|50|0|Physical|0|0|1
...
vehicles.   The best you can do is simply remove the vehicle help files; the 
commands will still be there, but without any vehicle types defined it doesn't 
really matter.
...
* Toughness ability - Configure the ability that is used for KO rolls.  
